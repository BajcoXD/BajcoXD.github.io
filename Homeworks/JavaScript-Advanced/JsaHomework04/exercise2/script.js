...
class Student {
  ...
  startAcademy(academy) {
    ...
    if (!academy.students.includes(this)) {
      // Ensure student is added to academy
  ...
  startSubject(subject) {
    if (this.academy && this.academy.subjects.includes(subject)) {
      if (this.currentSubject) {
        this.completedSubjects.push(this.currentSubject); // Move current subject to completed subjects
      }
      this.currentSubject = subject;
      if (!subject.students.includes(this)) {
          // Ensure student is added to subject
